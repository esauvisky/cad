...
module x_end_base()
{
    ...
    difference()
    {
        ...
        translate(v=[0,-17, -1]) cylinder(h = 20, r = 5.4, $fn = 60);
    }
...
// TR Nut trap
   // Hole for the nut
    ...
    translate(v=[0,-17, -1]) cylinder(h = 14.51, r = 5.4, $fn = 60);
    translate(v=[0,-17, -0.1]) cylinder(h = 1, r1 = 5.9,r2 = 5.4, $fn = 60);

// Screw holes for TR nut
    translate(v=[0,-17, 0]) rotate([0, 0, -135]) translate([0, 8.2, -4]) cylinder(h = 19, r = 1.65, $fn=50);
    translate(v=[0,-17, 0]) rotate([0, 0, -135]) translate([0, -8.2, -4]) cylinder(h = 19, r = 1.65, $fn=50);

    translate(v=[0,-17,0]) rotate([0,0,-135]) translate([0,8.2,-1]) cylinder(h=2, r1=2.2,r2=1.65, $fn=50);
    translate(v=[0,-17,0]) rotate([0,0,-135]) translate([0,-8.2,-1]) cylinder(h=2, r1=2.2,r2=1.65,, $fn=50);


// Nut traps for TR nut screws
    translate(v=[0,-17, 0]) rotate([0, 0, -135]) translate([0, 8.2, 11]) rotate([0, 0, 0])cylinder(h = 6, r = 3.15, $fn=6);

    translate(v=[0,-17, 0]) rotate([0,0,-135]) translate([0,-8.2,10]) rotate([0,0,30])cylinder(h = 3, r = 3.1, $fn=6);
    ...
    difference()
    {
        translate(v=[0,-17, 0]) rotate([0,0,-135]) translate([0,-8.2,5.8]) rotate([0,0,30])cylinder(h = 1, r = 3.1, $fn=6);
